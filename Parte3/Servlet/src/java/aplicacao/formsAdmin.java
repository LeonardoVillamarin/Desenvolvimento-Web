...
public class formsAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id.isEmpty() || nome.isEmpty() || cpf.isEmpty() || senha.isEmpty()){
            ...
            try{
                PreparedStatement stmt = conexao.prepareStatement("select * from administradores where id = (?)");
                stmt.setString(1, id);
                ...
                stmt = conexao.prepareStatement("select * from administradores where cpf = (?)");
