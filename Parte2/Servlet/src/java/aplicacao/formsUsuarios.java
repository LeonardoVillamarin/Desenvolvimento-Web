    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id.isEmpty() || nome.isEmpty() || cpf.isEmpty() || senha.isEmpty() || suspenso.isEmpty()){
            ...
            try{
                ...
                ResultSet rs = dao.getUser(id, cpf);
                boolean repetido = false;
                while(rs.next()){
                    if (rs.getString("cpf").equals(cpf) && rs.getString("id").equals(id)){
                        dao.setUserUpdate(id, cpf, suspenso);
                ...
                if (repetido == false){
                    dao.setUser(id, nome, cpf, senha, suspenso);
